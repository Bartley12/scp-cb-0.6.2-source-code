...
Function CreateParticle.Particles(x#, y#, z#, image%, size#, gravity# = 1.0, lifetime% = 200)
	...
	p\obj = CreateSprite() ; Updated for Blitz3D 1.108 compatibility
	...
	p\pvt = CreatePivot() ; Updated for Blitz3D 1.108 compatibility
...
Function CreateEmitter.Emitters(x#, y#, z#, emittertype%) 
	...
	e\Obj = CreatePivot() ; Updated for Blitz3D 1.108 compatibility
