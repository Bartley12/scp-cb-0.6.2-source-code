...
Function FillRoom(r.Rooms)
	...
	;FlipMesh r\Objects[1]
		...
		Case "room173"
			...
			r\RoomDoors[1] = CreateDoor(r\level, EntityX(r\obj) + 288.0 * RoomScale, 0, EntityZ(r\obj) + 384.0 * RoomScale, 90, r, True, True)
...
Function CreateMap()
	...
	For lvl = 0 To 0
		...
		MapRoom(ROOM2, Floor(Rnd(0.45,0.55)*Float(Room2Amount))) = "room2tunnel"
		...
		MapRoom(ROOM3, Floor(0.6*Float(Room3Amount))) = "room3servers2"
	...
	;r = CreateRoom(0, ROOM1, -100, 0, MapHeight*8, "forest")
	;MapRoomID(ROOM1)=MapRoomID(ROOM1)+1
...
;~F#2#9#26#ED#FE#10F#12A#133#13E#149#175#184#1BD#716#741#75C#761#770#789#80B
;~F#8E5#902#909#917#930#93C#AB4
;~C#Blitz3D