...
Function UpdateLauncher()
	...
	Graphics3D(LauncherWidth, LauncherHeight, 0, 2) ; Updated for Blitz3D 1.108 compatibility
	; FastExt compatibility - InitExt replacement for Blitz3D 1.108
	; Note: InitExt requires FastExt library which is not compatible with Blitz3D 1.108
	; InitExt
...
;~F#246#2E8#2FA#304#338#3C3#3D6#3F0#3F9#40C#426#43A#468#47E#4C0
;~C#Blitz3D